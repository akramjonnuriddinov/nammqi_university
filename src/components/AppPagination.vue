...
<template>
  <div class="flex items-center justify-between bg-white px-4 py-10 sm:px-6">
      ...
      <div class="w-full flex justify-center">
        <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
          ...
          >
            ...
            <inline-svg src="svg/left-icon.svg" class="h-5 w-5" />
          </a>
          <a
            href="#"
            aria-current="page"
          ...
          >
            ...
            <inline-svg src="svg/right-icon.svg" class="h-5 w-5" />
          </a>
        </nav>
      </div>
    </div>
